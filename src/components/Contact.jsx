      ...
      <div className='flex justify-between items-center mt-8 lg:mt-16 flex-col lg:flex-row'>
        ...
        >
          <div className='font-extrabold text-2xl lg:text-5xl mt-5 lg:mt-0 space-y-1 lg:space-y-3'>
            <h2>Let&apos;s <span className='text-white' style={{ WebkitTextStroke: '1px black' }}>build</span> something</h2>
            <h2>Impactful together</h2>
          </div>

          <p className='text-[#71717A] text-sm/6 lg:text-base mt-3 lg:mt-6'>
            I am always open to discussing mobile architecture, fintech scalability, technical challenges, or engineering leadership opportunities.
          </p>
          ...
          <div className='font-semibold text-sm lg:text-xl flex flex-col mt-6 gap-2 lg:gap-4'>
            <motion.a
              ...
              href="mailto:wahyu.abieddev@gmail.com"
            >
